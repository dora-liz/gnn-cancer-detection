...
Outputs:
- models/gnn_model_trained_cpu.pt / link_predictor_trained_cpu.pt
- models/training_artifacts.pt (hyperparameters, history, ranking metrics)
"""
...
def main():
    ...
    torch.save(projector.state_dict(), MODELS_DIR / "feature_projector_trained_cpu.pt")
    torch.save(model.state_dict(), MODELS_DIR / "gnn_model_trained_cpu.pt")
    torch.save(decoder.state_dict(), MODELS_DIR / "link_predictor_trained_cpu.pt")
    ...
    torch.save(artifacts, MODELS_DIR / "training_artifacts.pt")
