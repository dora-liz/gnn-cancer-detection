...
def parse_args():
    ...
    parser.add_argument("--base-graph", default=str(DATA_DIR / "gdsc_processed_train.pt"), help="Graph with known drugs/cell lines")
    parser.add_argument("--artifacts", default=str(MODELS_DIR / "training_artifacts.pt"))
    parser.add_argument("--projector-weights", default=str(MODELS_DIR / "feature_projector_trained_cpu.pt"))
    parser.add_argument("--model-weights", default=str(MODELS_DIR / "gnn_model_trained_cpu.pt"))
    parser.add_argument("--decoder-weights", default=str(MODELS_DIR / "link_predictor_trained_cpu.pt"))
